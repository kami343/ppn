...
<div class="main">
    <div style="padding: 15px;">
        ...
        <table>
            ...
            <tr>
                <td><b style="margin-bottom: 10px;display: inline-block;font-size: 18px;">Dear Adam,</b></td>
            </tr>
            <tr>
                <td><p style="margin-bottom: 0px;margin-top: 10px;"> {{$player->player1_name}} has cancelled request.</td>
            </tr>
            <tr>
                <td><p style="margin-bottom: 0px;margin-top: 10px;">League Name: {{$league->title}}</p></td>
                <td><p style="margin-bottom: 0px;margin-top: 10px;">Player 2: {{$player->player2_name}}</p></td>
            </tr>
