...
<div class="main">
    <div style="padding: 15px;">
        ...
        <table>
            ...
            <tr>
                <td><p style="margin-bottom: 0px;margin-top: 10px;">You will receive a refund within 5-10 business days (if not sooner) and you will be added back to the list to find another partner. Click <a href="{{url('/league-registration/'.$league->leagueid)}}" class="lnklogin">here.</a>to go to the league page and find a partner today!</p></td>
            </tr>
