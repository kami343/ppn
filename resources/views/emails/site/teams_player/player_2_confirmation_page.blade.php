            ...
            <div class="loginpage">
                <div class="row">
                    <div class="col-lg-8 email-pl m-auto">
                        ...
                        <p class="txtmail">You are now registered for the <br> <b>{{$full_name}}</b></p>
                        <p class="txtmail">You can access your league page <a href="{{url('/league-registration')}}/{{$leagueid}}/{{$user2}}" class="lnklogin">here.</a></p>
                        <div class="didn-rec">
