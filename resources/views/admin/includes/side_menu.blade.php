...
<aside class="left-sidebar" data-sidebarbg="skin6">
    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            ...
            <!-- New League Module -->
            @php
            $newleagueRoutes = ['newLeague.create','newLeague.list','newLeague.add','newLeague.edit','newLeague.sort'];
            @endphp
            @if (isset($isSuperAdmin))
            <li class="sidebar-item @if (in_array($currentPage, $newleagueRoutes))selected @endif">
                <a class="sidebar-link has-arrow @if (in_array($currentPage, $newleagueRoutes))active @endif" href="javascript:void(0)" aria-expanded="false">
                    <i data-feather="command" class="feather-icon"></i><span class="hide-menu"> @lang('custom_admin.new_league_module')</span>
                </a>
                <ul aria-expanded="false" class="collapse first-level base-level-line @if (in_array($currentPage, $videoRoutes))in @endif">
                    <li class="sidebar-item">
                        <a href="{{route('admin.newLeague.create')}}" class="sidebar-link sub-menu">
                            <span class="hide-menu"> @lang('custom_admin.new_league_create')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{route('admin.newLeague.list')}}" class="sidebar-link sub-menu">
                            <span class="hide-menu"> @lang('custom_admin.label_list')</span>
                        </a>
                    </li>
