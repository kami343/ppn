...
<body>
  ...
  $(document).ready(function (){
      $('#zip_code').on('input',function(e){
          // const clientKey='Jf0BemFsDfaM62FXJVteXJBKEaBT39wMEleVCX9HUC8YcKStd2aK8nZoVGrIEZ6';
          const zipcode=$('#zip_code').val();
          const clientKey = 'o1PrHu566YSsS1zvegzPWORrPxpD3gUOWSYAU8QKxNpN6gw3RQod8Xdivyx15EPz';
          const url = "https://www.zipcodeapi.com/rest/"+clientKey+"/info.json/" + zipcode + "/radians";
          // const url2='http://www.zipcodeapi.com/rest/<api_key>/distance.<format>/<zip_code1>/<zip_code2>/mile'.
          if (zipcode.length == 5) {
              $.ajax({
                  url: "http://127.0.0.1:8000/api/zipcode/"+zipcode,
                  type: 'GET',
