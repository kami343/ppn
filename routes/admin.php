...
Route::group(['namespace' => 'admin', 'prefix' => 'adminpanel', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => 'backend'], function () {
        ...
        Route::group(['middleware' => 'admin'], function () {
            ...
            Route::group(['prefix' => 'newLeague', 'as' => 'newLeague.'], function () {

                Route::get('/', 'NewLeagueController@index')->name('create');
                Route::post('/storedata', 'NewLeagueController@store')->name('storedata');
                Route::post('/ajax-list-request', 'NewLeagueController@ajaxListRequest')->name('ajax-list-request');
                Route::get('/edit/{id}', 'NewLeagueController@edit')->name('edit');
                Route::post('/update/{id}', 'NewLeagueController@update')->name('update');
