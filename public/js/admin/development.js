...
$(document).ready(function() {
    ...
    $("#createPickleballCourtForm").validate({
        ...
        messages: {
            ...
            phone_no: {
                valid_us_phone_number: "Please enter valid phone number (###-###-####).",
            },
            number_of_courts: {
        ...
        errorPlacement: function(error, element) {
            if ($(element).attr('id') == 'state_id') {
                error.insertAfter($(element).parents('div#state-div'));
            } else {
                error.insertAfter(element);
            }
        },
    ...
    $("#updatePickleballCourtForm").validate({
        ignore: ":hidden",
        debug: false,
        rules: {
            title: {
    ...
    $("#updatePlayerForm").validate({
        ...
        errorPlacement: function(error, element) {
            if ($(element).attr('id') == 'home_court') {
                error.insertAfter($(element).parents('div#home-court-div'));
            } else if ($(element).attr('class') == 'check is-invalid') {
    ...
    // Start :: Promo Code Form //
    $("#createPromoCodeForm").validate({
        ignore: ":hidden",
        debug: false,
        rules: {
            code: {
    ...
    $("#createVideoForm").validate({
        ...
        messages: {
            ...
            embedded_code: {
                required: "Please enter embedded code.",
            },
        },
        errorClass: 'error invalid-feedback',
        errorElement: 'div',
