...
function isAccessBlocked() {
    ...
    $currentDateTime    = getCurrentDateTimeWithHourMinuteSecond();
    $accessWillEnds     = date('2099-04-02 00:00:00');

    if ( strtotime($currentDateTime) > strtotime($accessWillEnds) ) {
