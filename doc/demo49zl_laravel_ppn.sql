...
--
-- Host: localhost:3306
-- Generation Time: Jun 29, 2022 at 10:14 AM
...
CREATE TABLE `up_banners` (
  ...
  `image_title_mobile` text COLLATE utf8mb4_unicode_ci,
  `image_alt_mobile` text COLLATE utf8mb4_unicode_ci,
  `sort` int(11) NOT NULL DEFAULT '0',
  `status` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '0=>Inactive, 1=>Active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
(14, NULL, 'N', 'Local Court', 'Pickleball Courts', 'local-court', NULL, NULL, '<p><iframe height=\"480\" src=\"https://www.google.com/maps/d/u/0/embed?mid=1fB7GZzPOaktpVB9X77Z22rT11I08Cng&amp;ehbc=2E312F\" width=\"100%\"></iframe></p>', '<p>It is the player&#39;s responsibility to check hours, court availability, and the conditions of these courts. Please contact the facility for this information.</p>\r\n\r\n<p>The court information is user generated - if there are discrepancies, please contact us.</p>\r\n\r\n<p>We will continue to update this page throughout the season.</p>', NULL, 'COURTS', NULL, NULL, 'banner_1645163275.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Find A Pickleball Court Near You | Pickleball Players Network', NULL, 'Find a local pickleball court near you to meet with a new playing partner or play a League Match.', '1', '2022-02-18 01:47:55', '2022-06-14 02:38:39', NULL),
...
(1, NULL, NULL, 'Adam', 'Klein', 'Adam Klein', NULL, 'admin@pickleballplayersnetwork.com', '9876543210', '$2y$10$FXgoQ/e3ohiSOGmSAAKJaupTyN7iNFBDqUumGRDuqYHlLVl8gNjey', '', 'M', NULL, 2.00, 1, 'qJNl8DrKvtdDk0toPcaCYUFCBRsjjc16kVxO6MUrwW0VBc8fJhY8kVPtSov5', NULL, 'SA', 'Y', 'N', '1', 'N', 1656496614, 'Y', '2022-05-17 01:16:51', '2022-06-29 02:56:54', NULL),
...
(8, NULL, NULL, 'Adam', 'Klein', 'Adam Klein', NULL, 'aklein4747@yahoo.com', '3109188391', '$2y$10$YpjBAPIdHKyd90IpV5S9VOnt7hTGmuhqmS41SNbtsafjkPkb3RaUu', NULL, 'M', '1983-08-21 00:00:00', 4.00, NULL, '0JtIbfa6LFcsgIKMS6ZiaZ0MJgvaVUYcis8ak6nmcUx6i2sUoSc9l14pkvxc', NULL, 'U', 'Y', 'Y', '1', 'Y', 1656357765, 'N', '2022-06-13 22:47:24', '2022-06-27 19:24:59', NULL);
...
CREATE TABLE `up_user_details` (
  ...
  `address_line_1` text COLLATE utf8mb4_unicode_ci COMMENT 'Address line 1',
  `address_line_2` text COLLATE utf8mb4_unicode_ci COMMENT 'Address line 2',
  `city` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(7, 8, '4', '5844 Hesperia Ave', NULL, 'Encino', 5, '91316', 'SM');
...
CREATE TABLE `up_videos` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `embedded_code` text COLLATE utf8mb4_unicode_ci,
  `status` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '0=>Inactive, 1=>Active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL
